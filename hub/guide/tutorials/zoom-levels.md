...
map.setView([0, 0], 0);
```
<RenderMap @mapReady="onSetZoomMapReady" />
...
<iframe width="696" height="392" src="https://www.youtube.com/embed/kIID5FDi2JQ" frameborder="0" allowfullscreen></iframe>
...
<div class="flex flex-wrap gap-2 justify-center">
    <img src="https://a.basemaps.cartocdn.com/light_all/1/0/0.png" class="border border-gray-300 rounded" alt=""/>
    <img src="https://a.basemaps.cartocdn.com/light_all/1/1/0.png" class="border border-gray-300 rounded" alt=""/>
    <img src="https://a.basemaps.cartocdn.com/light_all/1/0/1.png" class="border border-gray-300 rounded" alt=""/>
    <img src="https://a.basemaps.cartocdn.com/light_all/1/1/1.png" class="border border-gray-300 rounded" alt=""/>
</div>
...
<tbody>
    ...
    <td>
        <div class="flex items-center justify-center">
            <img src="https://a.basemaps.cartocdn.com/light_all/0/0/0.png"  class="size-[64px]"/>
        </div>
    </td>
    <td>
        <div class='grid grid-cols-2 gap-1'>
            <img src="https://a.basemaps.cartocdn.com/light_all/1/0/0.png" class="size-[64px] border border-gray-300 rounded justify-self-end self-end" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/1/1/0.png" class="size-[64px] border border-gray-300 rounded justify-self-start self-end" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/1/0/1.png" class="size-[64px] border border-gray-300 rounded justify-self-end self-start" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/1/1/1.png" class="size-[64px] border border-gray-300 rounded justify-self-start self-start" alt=""/>
        </div>
    </td>
    <td>
        <div class='grid grid-cols-4 gap-1'>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/0/0.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/1/0.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/2/0.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/3/0.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/0/1.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/1/1.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/2/1.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/3/1.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/0/2.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/1/2.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/2/2.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/3/2.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/0/3.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/1/3.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/2/3.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
            <img src="https://a.basemaps.cartocdn.com/light_all/2/3/3.png" class="size-[64px] border border-gray-300 rounded" alt=""/>
        </div>
    </td>
    </tr>
    <tr>
        <td class="text-center">Zoom 0</td>
        <td class="text-center">Zoom 1</td>
        <td class="text-center">Zoom 2</td>
    </tr>
</tbody>
</table>
...
By adding a `ScaleControl` to a map, and panning to the equator and to 60° north,
...
```
<RenderMap @mapReady="onScaleMapReady" />

`ScaleControl` shows the scale which applies to the center point of the map.
...
<RenderMap @mapReady="onSetZoomExampleReady" />
...
<RenderMap @mapReady="onFractionalExampleReady" />
...
(from the default [`ZoomControl`](/reference.html#control-zoom))
...
const onScaleMapReady = (map) => {
	...
	const positron = new L.TileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png', {
		attribution: cartodbAttribution
	}).addTo(map);

	const scaleControl = new L.Control.Scale({maxWidth: 150}).addTo(map);
...
const onSetZoomMapReady = (map) => {
    map.options.minZoom = 0;
    map.options.maxZoom = 0;
...
const onSetZoomExampleReady = (map) => {
    map.options.minZoom = 0;
    map.options.maxZoom = 1;
	...
	class ZoomViewer extends L.Control {
		onAdd() {
...
const onFractionalExampleReady = (map) => {
    map.options.minZoom = 0;
    map.options.maxZoom = 1;
